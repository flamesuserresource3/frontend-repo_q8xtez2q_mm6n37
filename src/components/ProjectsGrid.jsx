...
export default function ProjectsGrid() {
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {projects.map((p, i) => (
        <div key={p.title} style={{ perspective: 1000 }}>
          <motion.a
            href={p.link}
            target="_blank"
            rel="noreferrer"
            ...
            className="group relative block overflow-hidden rounded-xl border border-sky-400/20 bg-white/5 p-5 backdrop-blur hover:border-sky-300/40"
            style={{ boxShadow: '0 0 30px rgba(56,189,248,0.12)', transformStyle: 'preserve-3d' }}
          >
            ...
            {/* shine */}
            <div className="pointer-events-none absolute -inset-1 opacity-0 transition duration-500 group-hover:opacity-20" style={{
              backgroundImage: 'linear-gradient(110deg, transparent 20%, rgba(255,255,255,0.6) 50%, transparent 80%)',
